...
type RegisterReq struct {
	...
	UserName string `protobuf:"bytes,1,opt,name=userName,proto3" json:"userName,omitempty" form:"userName" query:"userName"` //name
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" form:"password" query:"password"` //password
}
...
type RegisterResp struct {
	...
	UserId     uint64 `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" form:"user_id" query:"user_id"`                     //userId
	Token      string `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty" form:"token" query:"token"`                                          //token
}
...
type LoginReq struct {
	...
	UserName string `protobuf:"bytes,1,opt,name=userName,proto3" json:"userName,omitempty" form:"userName" query:"userName"` //userName
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" form:"password" query:"password"` //password
}
...
type LoginResp struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty" form:"status_code" query:"status_code"` //状态码，0-成功，其他值-失败
	StatusMsg  string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`       //返回状态描述
	UserId     uint64 `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" form:"user_id" query:"user_id"`
	Token      string `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty" form:"token" query:"token"` //token
}
...
type UserInfoReq struct {
	...
	UserId uint64 `protobuf:"varint,1,opt,name=userId,proto3" json:"userId,omitempty" form:"userId" query:"userId"` //userId
	Token  string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty" form:"token" query:"token"`      //token
}
...
var file_userInfo_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x42, 0x27, 0x5a, 0x25, 0x70, 0x61, 0x69, 0x67, 0x75, 0x31, 0x39, 0x30, 0x32,
	0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x50, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
