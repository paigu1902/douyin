...
type VideoUploadReq struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token" form:"token" query:"token"`
	Data  []byte `protobuf:"bytes,2,opt,name=data,proto3" json:"data" form:"data" query:"data"`
...
type VideoUploadResp struct {
	...
	Status    int32  `protobuf:"varint,1,opt,name=status,proto3" json:"status" form:"status" query:"status"`
	StatusMsg string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg" form:"status_msg" query:"status_msg"`
}
...
type FeedReq struct {
	...
	LatestTime int64  `protobuf:"varint,1,opt,name=latest_time,json=latestTime,proto3" json:"latest_time" form:"latest_time" query:"latest_time"` // 可选参数，限制返回视频的最新投稿时间戳，精确到秒，不填表示当前时间
	Token      string `protobuf:"bytes,2,opt,name=token,proto3" json:"token" form:"token" query:"token"`                                          // 可选参数，登录用户设置
}
...
var file_videoOperator_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x32, 0x99, 0x01,
	...
	0x2e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x42, 0x2c, 0x5a, 0x2a, 0x70, 0x61, 0x69,
	0x67, 0x75, 0x31, 0x39, 0x30, 0x32, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x62, 0x69,
	0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x6f, 0x72, 0x50, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_videoOperator_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_videoOperator_proto_depIdxs = []int32{
	...
	0, // 2: videoOperatorPb.VideoOperator.Upload:input_type -> videoOperatorPb.VideoUploadReq
	2, // 3: videoOperatorPb.VideoOperator.Feed:input_type -> videoOperatorPb.FeedReq
	1, // 4: videoOperatorPb.VideoOperator.Upload:output_type -> videoOperatorPb.VideoUploadResp
	3, // 5: videoOperatorPb.VideoOperator.Feed:output_type -> videoOperatorPb.FeedResp
