...
type FavoActionReq struct {
	...
	Type    int32 `protobuf:"varint,3,opt,name=type,proto3" json:"type,omitempty" form:"type" query:"type"`             // 1-点赞，2-取消点赞
}
...
type FavoListResp struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=statusCode,proto3" json:"statusCode,omitempty" form:"statusCode" query:"statusCode"` // 状态码，0-成功，其他值-失败
	StatusMsg  string `protobuf:"bytes,2,opt,name=statusMsg,proto3" json:"statusMsg,omitempty" form:"statusMsg" query:"statusMsg"`      // 返回状态描述
	VideoList  *Video `protobuf:"bytes,3,opt,name=videoList,proto3" json:"videoList,omitempty" form:"videoList" query:"videoList"`      // 用户点赞视频列表
}
...
type Video struct {
	...
	PlayUrl       string `protobuf:"bytes,3,opt,name=playUrl,proto3" json:"playUrl,omitempty" form:"playUrl" query:"playUrl"`                          // 视频播放地址
	CoverUrl      string `protobuf:"bytes,4,opt,name=coverUrl,proto3" json:"coverUrl,omitempty" form:"coverUrl" query:"coverUrl"`                      // 视频封面地址
	FavoriteCount int64  `protobuf:"varint,5,opt,name=favoriteCount,proto3" json:"favoriteCount,omitempty" form:"favoriteCount" query:"favoriteCount"` // 视频的点赞总数
	CommentCount  int64  `protobuf:"varint,6,opt,name=commentCount,proto3" json:"commentCount,omitempty" form:"commentCount" query:"commentCount"`     // 视频的评论总数
	FavoStatus    bool   `protobuf:"varint,7,opt,name=favoStatus,proto3" json:"favoStatus,omitempty" form:"favoStatus" query:"favoStatus"`             // true-已点赞，false-未点赞
...
type User struct {
	...
	IsFollow      string `protobuf:"bytes,5,opt,name=isFollow,proto3" json:"isFollow,omitempty" form:"isFollow" query:"isFollow"`
}
...
var file_userFavo_proto_rawDesc = []byte{
	...
	0x12, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x6f, 0x50, 0x62, 0x22, 0x55, 0x0a, 0x0d,
	...
	0x79, 0x70, 0x65, 0x22, 0x4e, 0x0a, 0x0e, 0x46, 0x61, 0x76, 0x6f, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d,
	0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x4d, 0x73, 0x67, 0x22, 0x25, 0x0a, 0x0b, 0x46, 0x61, 0x76, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x7d, 0x0a, 0x0c, 0x46, 0x61,
	0x76, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1e, 0x0a, 0x0a, 0x73, 0x74,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x2f, 0x0a, 0x09, 0x76, 0x69, 0x64, 0x65,
	0x6f, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x46, 0x61, 0x76, 0x6f, 0x50, 0x62, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09,
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xf7, 0x01, 0x0a, 0x05, 0x56, 0x69,
	...
	0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x46, 0x61, 0x76, 0x6f, 0x50, 0x62,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x18, 0x0a,
	0x07, 0x70, 0x6c, 0x61, 0x79, 0x55, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	...
	0x55, 0x72, 0x6c, 0x12, 0x24, 0x0a, 0x0d, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x66, 0x61, 0x76, 0x6f,
	0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x6f, 0x6d,
	...
	0x0a, 0x66, 0x61, 0x76, 0x6f, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0a, 0x66, 0x61, 0x76, 0x6f, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a,
	0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69,
	0x74, 0x6c, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06,
	...
	,
}
