...
type DouyinCommentNumberRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DouyinCommentNumberRequest) Reset() {
	*x = DouyinCommentNumberRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinCommentNumberRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinCommentNumberRequest) ProtoMessage() {}

func (x *DouyinCommentNumberRequest) ProtoReflect() protoreflect.Message {
	mi := &file_comment_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinCommentNumberRequest.ProtoReflect.Descriptor instead.
func (*DouyinCommentNumberRequest) Descriptor() ([]byte, []int) {
	return file_comment_proto_rawDescGZIP(), []int{6}
}

func (x *DouyinCommentNumberRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *DouyinCommentNumberRequest) GetVideoId() int64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
type DouyinCommentNumberResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码，0-成功，其他值-失败
	StatusMsg  string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     // 返回状态描述
	Count      int64  `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"`                             // 评论列表
}

func (x *DouyinCommentNumberResponse) Reset() {
	*x = DouyinCommentNumberResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinCommentNumberResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinCommentNumberResponse) ProtoMessage() {}

func (x *DouyinCommentNumberResponse) ProtoReflect() protoreflect.Message {
	mi := &file_comment_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinCommentNumberResponse.ProtoReflect.Descriptor instead.
func (*DouyinCommentNumberResponse) Descriptor() ([]byte, []int) {
	return file_comment_proto_rawDescGZIP(), []int{7}
}

func (x *DouyinCommentNumberResponse) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *DouyinCommentNumberResponse) GetStatusMsg() string {
	if x != nil {
		return x.StatusMsg
	}
	return ""
...
func (x *DouyinCommentNumberResponse) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_comment_proto_rawDesc = []byte{
	...
	0x0a, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x50, 0x62, 0x22, 0xb6, 0x01, 0x0a, 0x1d,
	...
	0x6e, 0x74, 0x49, 0x64, 0x22, 0x8f, 0x01, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f,
	...
	0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x2d, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43,
	0x6f, 0x6d, 0x6d, 0x50, 0x62, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07, 0x63,
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x7a, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x12, 0x24, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x50, 0x62, 0x2e, 0x55, 0x73, 0x65,
	...
	0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x22, 0x51, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x96, 0x01, 0x0a, 0x1c, 0x64, 0x6f,
	...
	0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x36, 0x0a, 0x0c, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x50, 0x62, 0x2e, 0x43, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69,
	0x73, 0x74, 0x22, 0x53, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x71, 0x75,
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x76, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69,
	0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72,
	...
	,
}
...
var file_comment_proto_goTypes = []interface{}{
	(*DouyinCommentActionRequest)(nil),  // 0: UserCommPb.douyin_comment_action_request
	(*DouyinCommentActionResponse)(nil), // 1: UserCommPb.douyin_comment_action_response
	(*Comment)(nil),                     // 2: UserCommPb.Comment
	(*User)(nil),                        // 3: UserCommPb.User
	(*DouyinCommentListRequest)(nil),    // 4: UserCommPb.douyin_comment_list_request
	(*DouyinCommentListResponse)(nil),   // 5: UserCommPb.douyin_comment_list_response
	(*DouyinCommentNumberRequest)(nil),  // 6: UserCommPb.douyin_comment_number_request
	(*DouyinCommentNumberResponse)(nil), // 7: UserCommPb.douyin_comment_number_response
}
var file_comment_proto_depIdxs = []int32{
	2, // 0: UserCommPb.douyin_comment_action_response.comment:type_name -> UserCommPb.Comment
	3, // 1: UserCommPb.Comment.user:type_name -> UserCommPb.User
	2, // 2: UserCommPb.douyin_comment_list_response.comment_list:type_name -> UserCommPb.Comment
	0, // 3: UserCommPb.UserCommRpc.CommentAction:input_type -> UserCommPb.douyin_comment_action_request
	4, // 4: UserCommPb.UserCommRpc.GetCommentsByVideo:input_type -> UserCommPb.douyin_comment_list_request
	6, // 5: UserCommPb.UserCommRpc.GetCommentNumberByVideo:input_type -> UserCommPb.douyin_comment_number_request
	1, // 6: UserCommPb.UserCommRpc.CommentAction:output_type -> UserCommPb.douyin_comment_action_response
	5, // 7: UserCommPb.UserCommRpc.GetCommentsByVideo:output_type -> UserCommPb.douyin_comment_list_response
	7, // 8: UserCommPb.UserCommRpc.GetCommentNumberByVideo:output_type -> UserCommPb.douyin_comment_number_response
...
func file_comment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_comment_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinCommentNumberRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_comment_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinCommentNumberResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type UserCommRpc interface {
	CommentAction(ctx context.Context, req *DouyinCommentActionRequest) (res *DouyinCommentActionResponse, err error)
	GetCommentsByVideo(ctx context.Context, req *DouyinCommentListRequest) (res *DouyinCommentListResponse, err error)
	GetCommentNumberByVideo(ctx context.Context, req *DouyinCommentNumberRequest) (res *DouyinCommentNumberResponse, err error)
}
